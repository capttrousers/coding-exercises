...
public class DirectedWeightedGraphTest {
    ...
    private Graph DirectedWeightedGraph11,
    ...
    @Test
    public void djikstraShortestPathDirectedWeightedGraph11() throws Exception {
        List<Node> path = GraphSearch.djikstraShortestPath(DirectedWeightedGraph11, nodeH, nodeB);
        Assert.assertEquals(path.size(), 5);
    }
    ...
    @Test
    public void djikstraShortestPathDirectedWeightedGraph12() throws Exception {
        List<Node> path = GraphSearch.djikstraShortestPath(DirectedWeightedGraph12, nodeE, nodeF);
        Assert.assertEquals(path.size(), 3);
    }
    ...
    @Test
    public void djikstraShortestPathDirectedWeightedGraph13() throws Exception {
        List<Node> path = GraphSearch.djikstraShortestPath(DirectedWeightedGraph13, nodeG, nodeH);
        Assert.assertEquals(path.size(), 5);
    }
